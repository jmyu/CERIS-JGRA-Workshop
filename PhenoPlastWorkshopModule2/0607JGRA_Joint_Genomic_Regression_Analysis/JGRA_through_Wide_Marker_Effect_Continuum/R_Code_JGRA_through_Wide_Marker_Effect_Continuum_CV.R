...
library("BGLR")
library("yarrr")
Dir="C:/Users/tguo/Desktop/PhenoPlastWorkshopModule2/0607JGRA_Joint_Genomic_Regression_Analysis/JGRA_through_Wide_Marker_Effect_Continuum/";
source(paste(Dir,"Function_JGRA.R",sep=""))

png(paste(Dir,"JGRA_Marker_CV.png",sep=""),width= 6.5,height= 6.5,pointsize=10,units="in",res=600)
...
fold=5;
reshuffle=20;
out=JGRA.marker(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.E",fold,reshuffle)
out.1=out[[1]];
...
#Panel2#######################################################################################################################
###############################################################1:3
out=JGRA.marker(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.G",fold,reshuffle)
...
#Panel3#######################################################################################################################
###############################################################1:4
out=JGRA.marker(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.GE",fold,reshuffle)
