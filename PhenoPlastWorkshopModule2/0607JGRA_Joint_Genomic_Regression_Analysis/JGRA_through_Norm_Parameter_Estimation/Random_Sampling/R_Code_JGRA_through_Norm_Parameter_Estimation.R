...
library("BGLR")
library("yarrr")
Dir="C:/Users/tguo/Desktop/PhenoPlastWorkshopModule2/JGRA_Joint_Genomic_Regression_Analysis/JGRA_through_Norm_Parameter_Estimation/";

source(paste(Dir,"Function_JGRA_Norm.R",sep=""))

png(paste(Dir,"JGRA_Norm.png",sep=""),width= 6,height= 6,pointsize=10,units="in",res=600)
...
#1:2
out=JGRA(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.E")
out.1=out[[1]];
out.2=round(out[[2]],2);
size=1;size.p=0.2;
...
#Panel2#######################################################################################################################
###############################################################1:3
out=JGRA(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.G")
...
#Panel3#######################################################################################################################
###############################################################1:4
out=JGRA(LOC,pheno,geno,envir,enp,tt.line,tt.e,mets="RM.GE")
